...
The RHEL image is available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhel8/nginx-114)
as registry.access.redhat.com/rhel8/nginx-114.
...
*  **For CentOS based image**
    ```
    $ s2i build https://github.com/sclorg/nginx-container.git --context-dir=1.14/test/test-app/ centos/nginx-114-centos8 nginx-sample-app
    $ docker run -p 8080:8080 nginx-sample-app
    ```
